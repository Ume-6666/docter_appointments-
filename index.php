            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="http://127.0.0.1:5000/">Consult</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="medicine/eMedicine-Website/index.html">Services</a></li>
    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['setting_name'] ?> | <a href="" target="_blank"></a></div></div>
        </footer>
